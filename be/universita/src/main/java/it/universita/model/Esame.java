...
public class Esame implements Serializable {
	...
	@JoinColumn(name="MATERIA_ID", nullable=false, updatable=false, insertable=true)
	private Materia materia;
	
	@Id
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinColumn(name="STUDENTE_ID", nullable=false, updatable=false, insertable=true)
